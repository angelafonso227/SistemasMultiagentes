...
class ForestFire(Model):
       ...
       #se llena de arboles muertos 
        for contents, (x, y) in self.grid.coord_iter():
            ...
            if self.random.random() < density and y == 49:
                #solo cambia la condicion a un número random de los árboles con y=49
    ...
    def count_type(model, tree_condition):
        ...
        Se va a detener cuando y=50 por el tamaño especificado en el modelo
        """
